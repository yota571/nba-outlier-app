...
# - Game cards moved ABOVE tables, with team logos
...
# SIDEBAR UI
# =====================================================
st.sidebar.title("NBA Outlier-Style App (PrizePicks) – v1.8.1")
...
# =====================================================
st.title("NBA Prop Edge Finder (PrizePicks) – v1.8.1")
st.caption(
                            ...
                            with card:
                                ...
                                with col_btn2:
                                    if st.button(
                                        ...
                                        key=f"track_spread_{game_key}_{k}",
                                    ):
                                        bet = {
