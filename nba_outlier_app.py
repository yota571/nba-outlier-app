...
# Version 1.1 (adds per-player table filter on Table tab)
# =====================================================
...
# SIDEBAR UI
# =====================================================
st.sidebar.title("NBA Outlier-Style App (PrizePicks) – v1.1")
...
# =====================================================
st.title("NBA Prop Edge Finder (PrizePicks) – v1.1")
st.caption("PrizePicks full-game props vs nba_api stats → edges, confidence %, prediction, & model odds.")
...
# =====================================================
# TABS: CARDS + EXPLANATION / TABLE / PLAYER DETAIL
# =====================================================
tab_cards, tab_table, tab_player = st.tabs(
    ["Cards & Explanation", "Table", "Player Detail"]
)
...
with tab_table:
    ...
    # --- NEW: Player filter on the table tab ---
    ...
    if selected_table_player != "All players":
        ...
        if not player_all_lines.empty:
            ...
            st.dataframe(
                ...
                .sort_values(by=["confidence_pct", f"over_rate_last_{games_to_look_back}"], ascending=False),
