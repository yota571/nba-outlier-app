...
# - FIX: team logo lookup now robust to 'LAL', 'Lakers', 'Los Angeles Lakers', etc.
...
def get_team_logo_url(team_name: str | None) -> str | None:
    ...
    # Build abbreviation candidates like 'LAL' from
    # 'LAL', 'LAL Lakers', 'Los Angeles LAL', etc.
...
# SIDEBAR UI
# =====================================================
st.sidebar.title("NBA Outlier-Style App (PrizePicks) – v1.9.1")
...
# =====================================================
st.title("NBA Prop Edge Finder (PrizePicks) – v1.9.1")
st.caption(
