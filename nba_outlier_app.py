...
# - NEW: Model game spreads + highlight games with strong spreads
# =====================================================
...
# SIDEBAR UI
# =====================================================
st.sidebar.title("NBA Outlier-Style App (PrizePicks) – v1.6.0")
...
# =====================================================
st.title("NBA Prop Edge Finder (PrizePicks) – v1.6.0")
st.caption(
