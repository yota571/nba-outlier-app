...
# - NEW: Separate moneyline & spread tables + colored highlights + game card view
# =====================================================
...
# SIDEBAR UI
# =====================================================
st.sidebar.title("NBA Outlier-Style App (PrizePicks) – v1.7.0")
...
# =====================================================
st.title("NBA Prop Edge Finder (PrizePicks) – v1.7.0")
st.caption(
...
with tab_games:
    ...
    if games_ml_df.empty:
        ...
        if ml_df.empty:
            ...
            # GAME CARDS (like player cards, but at game level)
