...
# - FIX: relaxed status filter + safer "today" filter so more games appear
# =====================================================
...
# SIDEBAR UI
# =====================================================
st.sidebar.title("NBA Outlier-Style App (PrizePicks) – v1.3.2")
...
# =====================================================
st.title("NBA Prop Edge Finder (PrizePicks) – v1.3.2")
st.caption(
